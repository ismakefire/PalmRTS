...
{
    public class UiPlayerTransportConnectorPanel : MonoBehaviour
    {
        #region Types

        public class PlayerConnectorActions
        {
        }
        ...
        private readonly PanelModel<PlayerConnectorActions> _panelModel = new PanelModel<PlayerConnectorActions>();
        ...
        private static UiPlayerTransportConnectorPanel _instance = null;

        public static UiPlayerTransportConnectorPanel Instance
        {
            get
            {
                return _instance;
        ...
        public void ShowPanel(PlayerConnectorActions actions, TransportConnector transportConnector)
        {
        ...
        private OrdersCardsHandler AddOrdersButton(TransitOrderController transitOrder)
        {
            ...
            // Setup for use
            OrdersCardsHandler handler = new OrdersCardsHandler(null, transitOrder, newTransitOrderCard, RemoveOrder);
